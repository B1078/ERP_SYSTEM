...
{
    public class GoodsReceipt_Mst
    {
        public string? IsActive { get; set; }
        public string? GdReceiptId { get; set; }
    ...
    public class GoodsReceiptDet_Mst
    {
        public string? GdReceiptDetId { get; set; }
        public string? GdReceiptId { get; set; }
    ...
    public class GoodsReceiptAttchment
    {
