...
{
    public class InvtTrnsR_Mst
    {
        public string? IsActive { get; set; }
        public string? InvTransReqId { get; set; }
    ...
    public class InvtTrnsRDet_Mst
    {
        public string? InvTransReqDetId { get; set; }
        public string? InvTransReqId { get; set; }
    ...
    public class InvtTrnsRAttchment
    {
