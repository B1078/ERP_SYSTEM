...
{
    public class SalsReturn_MST
    {
        public string? IsActive { get; set; }
        public string? SalsReturnId { get; set; }
    ...
    public class SalsReturn_Item
    {
        public string? SalsRetDetId  { get; set; }
        public string? SalsReturnId { get; set; }
    ...
    public class SalsReturn_Attchment
    {
    ...
    public class SalsReturn_Freight
    {

        public string? SalsRetFretId { get; set; }
        public string? SalsReturnId { get; set; }
    ...
    public class SalsReturn_Taxinfo_Mst
    {
        public string? SalsRetTaxDetId  { get; set; }
        public string? SalsReturnId { get; set; }
