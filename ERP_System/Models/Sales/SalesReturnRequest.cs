namespace ERP_System.Models.Sales
{
    ...
    public class SalesReturnRequest
    {
        ...
        public string? SalesRReqId { get; set; }
    ...
    public class SalesReturnRequest_Item
    {
        public string? SalesRReqDetId { get; set; }
        public string? SalesRReqId { get; set; }
    ...
    public class SalesReturnRequest_Attchment
    {
    ...
    public class Freight_SalesReturnRequest
    {

        public string? SalesRReqFretId { get; set; }
        public string? SalesRReqId { get; set; }
    ...
    public class SalesReturnRequest_Taxinfo_Mst
    {
        public string? SalesRReqTaxDetId { get; set; }
        public string? SalesRReqId { get; set; }
