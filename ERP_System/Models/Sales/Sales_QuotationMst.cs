...
{
    public class Sales_QuotationMst
    {
        public string? IsActive { get; set; }
        public string? SalsQuotId { get; set; }
    ...
    public class Sales_Quot_Item
    {
        public string? SalsQDetId { get; set; }
        public string? SalsQuotId { get; set; }
    ...
    public class Freight_Quotation
    {
        ...
        public string? SalsQFretId { get; set; }
        public string? SalsQuotId { get; set; }
    ...
    public class SQTaxinfo_Mst
    {
        public string? SalsQTaxDetId { get; set; }
        public string? SalsQuotId { get; set; }
