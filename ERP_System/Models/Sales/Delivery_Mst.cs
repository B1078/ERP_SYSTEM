...
{
    public class Delivery_Mst
    {
        public string? IsActive { get; set; }
        public string? SalsDelId { get; set; }
    ...
    {
        public string? SalsDelDetId { get; set; }
        public string? SalsDelId { get; set; }
    ...
    public class DeliveryAttchment
    {
    ...
    public class Delivery_Freight
    {

        public string? SalsDelFretId { get; set; }
        public string? SalsDelId { get; set; }
    ...
    public class DeliveryTax_Mst
    {
        public string? SalsDelTaxDetId { get; set; }
        public string? SalsDelId { get; set; }
