namespace ERP_System.Models.Purchase
{
    ...
    public class GoodsReturnRequest_Item
    {
        public string? GDRReqDetId { get; set; }
        public string? GDRReqId { get; set; }
    ...
    public class GoodsReturnRequestAttchment
    {
    ...
    public class GoodsReturnRequest_Freight
    {

        public string? GDRReqFretId { get; set; }
        public string? GDRReqId { get; set; }
    ...
    public class GoodsReturnRequestTaxinfo_Mst
    {
        public string? GDRReqTaxDetId { get; set; }
        public string? GDRReqId { get; set; }
