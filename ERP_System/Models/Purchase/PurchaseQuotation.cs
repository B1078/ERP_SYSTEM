namespace ERP_System.Models.Purchase
{
    public class PurchaseQuotation
    {
        ...
        public string? PurQuotId { get; set; }
    ...
    public class Purchase_Quot_Item
    {
        public string? PurQDetId { get; set; }
        public string? PurQuotId { get; set; }
        public string? ItemId { get; set; }
        public string? LineNum { get; set; }
        public string? ItemReqdDt { get; set; }
        public string? ItemQuotDt { get; set; }
    ...
    public class Freight_Quotation
    {

        public string? PurQFretId { get; set; }
        public string? PurQuotId { get; set; }
    ...
    public class PQTaxinfo_Mst
    {
        public string? PurQTaxDetId { get; set; }
        public string? PurQuotId { get; set; }
