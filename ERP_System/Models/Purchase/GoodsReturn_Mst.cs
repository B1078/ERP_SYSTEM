...
{
    public class GoodsReturn_Mst
    {
        public string? IsActive { get; set; }
        public string? GDReturnId { get; set; }
    ...
    public class GoodsReturn_Item
    {
        public string? GDRetDetId { get; set; }
        public string? GDReturnId { get; set; }
    ...
    public class GoodsReturnAttchment
    {
    ...
    public class GoodsReturn_Freight
    {

        public string? GDRetFretId { get; set; }
        public string? GDReturnId { get; set; }
    ...
    public class GoodsReturnTaxinfo_Mst
    {
        public string? GDRetTaxDetId { get; set; }
        public string? GDReturnId { get; set; }
