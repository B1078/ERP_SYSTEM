namespace ERP_System.Models.Purchase
{
    ...
    public class GRPO_Item
    {
        public string? GRPODetId { get; set; }
        public string? GRPOId { get; set; }
    ...
    public class GRPO_Freight
    {

        public string? GRPOFretId { get; set; }
        public string? GRPOId { get; set; }
    ...
    public class GRPOTaxinfo_Mst
    {
        public string? GRPOTaxDetId { get; set; }
        public string? GRPOId { get; set; }
