namespace ERP_System.Models.Purchase
{
    ...
    {
        public string? PurODetId { get; set; }
        public string? PurOrderId { get; set; }
    ...
    public class PurchaseOrderAttchment
    {
    ...
    public class PurchaseOrder_Freight
    {

        public string? PurOFretId { get; set; }
        public string? PurOrderId { get; set; }
    ...
    public class POTaxinfo_Mst
    {
        public string? PurOTaxDetId { get; set; }
        public string? PurOrderId { get; set; }
