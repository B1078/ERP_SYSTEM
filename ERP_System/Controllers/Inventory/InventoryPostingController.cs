...
{
    public class InventoryPostingController : Controller
    {
        public IActionResult InventoryPosting()
        {
...
INNER JOIN Price_List_Mst PM ON PM.PListId = IC.PListId AND FM.IsActive = 'Y'  ";
