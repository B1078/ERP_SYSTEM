...
{
    public class UnitGroupMasterController : Controller
    {
        public IActionResult UnitGroupMaster()
        {
        ...
        public IActionResult GET()
        {
            try
            {
                ...
                string Query = @"select UGM.* , Um.UomName as BaseUomName
from Unit_GRP_Mst UGM
left join Unit_Mst UM on UM.UomId = UGM.BaseUomId   ";
        ...
        public IActionResult GETUNITDEFMST(string ID)
        {
            try
            {
                string ConnectionString = HttpContext.Session.GetString("ConnectionString");
                string Query = @"SELECT * from [Unit_GRP_DefMst]  where UomGRPId ='"+ ID + "'";
                List<Dictionary<string, object>> dataList = new List<Dictionary<string, object>>();
                using (SqlConnection con = new SqlConnection(ConnectionString))
                {
                    using (SqlCommand cmd = new SqlCommand(Query, con))
        ...
        public IActionResult POSTDATA(UnitGroup_Mst Data)
        {
            string ConnectionString = HttpContext.Session.GetString("ConnectionString");
            try
            {
                ...
                string insertQuery = genrate.GenerateInsertQuery(Data, "[Unit_GRP_Mst]", "UomGRPId");
                using (SqlConnection con = new SqlConnection(ConnectionString))
                {
                    con.Open();
                ...
                return Json(new { Success = true, Message = "Unit Group Master  Added Successfully..!" });
            }
            catch (SqlException sqlEx)
            {
                return StatusCode(500, "A Unit Group Master  with this Unit Group Name already exists. Please use a different nAME.");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult POSTDATAExcel(string data)
        {
            ...
            try
            {
                ...
                List<UnitGroup_Mst> units = JsonConvert.DeserializeObject<List<UnitGroup_Mst>>(data);
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    foreach (var unit in units)
                    {
                        try
                        {
                            ...
                            string insertQuery = genrate.GenerateInsertQuery(unit, "[Unit_GRP_Mst]", "UomGRPId");
        ...
        public IActionResult POSTUNITDEFGRPDATA([FromBody] List<UnitGrpD_mst> Data)
        {
            string ConnectionString = HttpContext.Session.GetString("ConnectionString");
            try
            {
                ...
                {
                    if (item.UomGRPDefId != "" && item.UomGRPDefId != null)
                    {
                        ...
                        Genrate_Query genrate = new Genrate_Query();
                        string Query = genrate.GenerateUpdateQuery(item, "[Unit_GRP_DefMst]", "UomGRPDefId", item.UomGRPDefId, "");
                        if (item.UomGRPDefId != null || item.UomGRPDefId != "")
                        {
                    ...
                    else
                    {
                        ...
                        Genrate_Query genrate = new Genrate_Query();
                        if (item.UomGRPId != null || item.UomGRPId != "")
                        {
                            string insertQuery = genrate.GenerateInsertQuery(item, "[Unit_GRP_DefMst]", "UomGRPDefId");
                            using (SqlConnection con = new SqlConnection(ConnectionString))
                            {
                                con.Open();
                                using (SqlCommand cmd = new SqlCommand(insertQuery, con))
                ...
                return Json(new { Success = true, Message = "Unit Group Defination  Master  Added Successfully..!" });
            }
            catch (Exception ex)
            {
                return StatusCode(500, ex.Message.ToString());
        ...
        public IActionResult UPDATEDATA(UnitGroup_Mst Data)
        {
            string ConnectionString = HttpContext.Session.GetString("ConnectionString");
            try
            {
                ...
                Data.UpdatedBy = HttpContext.Session.GetString("UserName");
                Genrate_Query genrate = new Genrate_Query();
                string Query = genrate.GenerateUpdateQuery(Data, "[Unit_GRP_Mst]", "UomGRPId", Data.UomGRPId, "");
                using (SqlConnection con = new SqlConnection(ConnectionString))
                {
                    con.Open();
                ...
                return Json(new { Success = true, Message = " Unit Group Master Updated Successfully..!" });
            }
            catch (Exception ex)
            {
                return StatusCode(500, ex.Message.ToString());
        ...
        public IActionResult DELETE(string Id)
        {
            ...
            try
            {
                ...
                string Query = "Delete from [Unit_GRP_Mst] where UomGRPId='" + Id + "'";
                List<Dictionary<string, object>> dataList = new List<Dictionary<string, object>>();
                using (SqlConnection con = new SqlConnection(ConnectionString))
                {
                    using (SqlCommand cmd = new SqlCommand(Query, con))
                ...
                return Json(new { success = true, message = "Unit Group Master Deleted Successfully..!" });
            }
            catch (Exception ex)
            {
                return StatusCode(500, ex.Message.ToString());
        ...
        public IActionResult DELETEDATA(string Id)
        {
            ...
            try
            {
                ...
                return Json(new { success = true, message = "Unit Group Defination Master Deleted Successfully..!" });
            }
            catch (Exception ex)
            {
                return StatusCode(500, ex.Message.ToString());
